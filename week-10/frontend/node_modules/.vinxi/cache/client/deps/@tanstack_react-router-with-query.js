...
// node_modules/@tanstack/react-router-with-query/dist/esm/index.js
...
function routerWithQueryClient(router, queryClient) {
  ...
  router.options = {
    ...
    Wrap: ({ children }) => {
      const OGWrap = ogOptions.Wrap || import_react.Fragment;
      return (0, import_jsx_runtime.jsx)(QueryClientProvider, { client: queryClient, children: (0, import_jsx_runtime.jsx)(OGWrap, { children }) });
    }
  };
  return router;
}
...
//# sourceMappingURL=@tanstack_react-router-with-query.js.map
