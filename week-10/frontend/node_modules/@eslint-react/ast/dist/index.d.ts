...
import { TSESTree, AST_NODE_TYPES as AST_NODE_TYPES$2 } from '@typescript-eslint/types';
import { TSESTree as TSESTree$1 } from '@typescript-eslint/utils';
import { SyntaxKind } from 'typescript';
import { AST_NODE_TYPES as AST_NODE_TYPES$1 } from '@typescript-eslint/typescript-estree';
 ...
 * @returns The first parent node that satisfies the test
 */
declare const findParentNodeGuard: {
 ...
 * @returns The first parent node that satisfies the test
 */
declare function findParentNodeStop(node: TSESTree.Node, stopNode: TSESTree.Node, predicate: (node: TSESTree.Node) => boolean): O.Option<TSESTree.Node>;
 ...
 */
declare function getClassIdentifier(node: TSESTreeClass): O.Option<TSESTree.Identifier>;
...
declare function getFunctionIdentifier(node: TSESTree.Expression | TSESTreeFunction): O.Option<TSESTree.Identifier>;

declare function getIdentifiersFromBinaryExpression(side: TSESTree.BinaryExpression | TSESTree.BinaryExpression["left"] | TSESTree.BinaryExpression["right"]): TSESTree.Identifier[];
 ...
 */
declare function getNestedExpressionsOfType<TNodeType extends AST_NODE_TYPES$1>(type: TNodeType): (node: TSESTree.Node) => Extract<TSESTree.Node, {
    type: TNodeType;
}>[];
...
declare function getTopLevelIdentifier(node: TSESTree.Node): O.Option<TSESTree.Identifier>;

declare const is: <NodeType extends AST_NODE_TYPES$2>(nodeType: NodeType) => (node: TSESTree$1.Node | null | undefined) => node is Extract<TSESTree$1.Node, {
    type: NodeType;
}>;
declare const isOneOf: <NodeTypes extends readonly AST_NODE_TYPES$2[]>(nodeTypes: NodeTypes) => (node: TSESTree$1.Node | null | undefined) => node is Extract<TSESTree$1.Node, {
...
declare const isControlFlow: effect_Predicate.Refinement<TSESTree$1.Node | null | undefined, TSESTree$1.DoWhileStatement | TSESTree$1.ForInStatement | TSESTree$1.ForOfStatement | TSESTree$1.ForStatement | TSESTree$1.IfStatement | TSESTree$1.SwitchStatement | TSESTree$1.WhileStatement>;
declare const isConditional: effect_Predicate.Refinement<TSESTree$1.Node | null | undefined, TSESTree$1.ConditionalExpression | TSESTree$1.DoWhileStatement | TSESTree$1.ForInStatement | TSESTree$1.ForOfStatement | TSESTree$1.ForStatement | TSESTree$1.IfStatement | TSESTree$1.LogicalExpression | TSESTree$1.SwitchStatement | TSESTree$1.WhileStatement>;
...
declare const isTypeExpression: (node: TSESTree$1.Node | null | undefined) => node is TSESTree$1.TSAsExpression | TSESTree$1.TSNonNullExpression | TSESTree$1.TSSatisfiesExpression | TSESTree$1.TSTypeAssertion;
 ...
 */
declare const isFunctionOfClassMethod: (node: TSESTree.Node) => boolean;
 ...
 */
declare const isFunctionOfClassProperty: (node: TSESTree.Node) => boolean;
 ...
 */
declare const isFunctionOfObjectMethod: (node: TSESTree.Node) => boolean;
