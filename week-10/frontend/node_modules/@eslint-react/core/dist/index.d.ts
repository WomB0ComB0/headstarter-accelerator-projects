...
declare function useComponentCollector(context: RuleContext, hint?: bigint): {
    readonly ctx: {
        ...
        readonly getCurrentFunction: () => O.Option<{
            key: string;
            node: AST.TSESTreeFunction;
            hookCalls: TSESTree.CallExpression[];
            isComponent: boolean;
        }>;
        readonly getCurrentFunctionStack: () => {
            key: string;
            node: AST.TSESTreeFunction;
            hookCalls: TSESTree.CallExpression[];
            isComponent: boolean;
    ...
    readonly listeners: {
        ...
        readonly "AssignmentExpression[type][operator='='][left.type='MemberExpression'][left.property.name='displayName']": (node: TSESTree.AssignmentExpression & {
 ...
 */
declare function isReactHookCall(node: TSESTree.Node): boolean;
...
declare const ERPhaseRelevance: _eslint_react_types.BiRecord<{
...
declare function isCallFromReact(name: string): IsCallFromReact;
...
declare function isCallFromReactMember(pragmaMemberName: string, name: string): IsCallFromReactMember;
...
declare const isChildrenCountCall: {
    (context: _eslint_react_types.RuleContext): (node: Node) => node is CallExpression & {
        callee: MemberExpression;
    };
    (node: Node, context: _eslint_react_types.RuleContext): node is CallExpression & {
        callee: MemberExpression;
    };
};
declare const isChildrenForEachCall: {
    (context: _eslint_react_types.RuleContext): (node: Node) => node is CallExpression & {
        callee: MemberExpression;
    };
    (node: Node, context: _eslint_react_types.RuleContext): node is CallExpression & {
...
declare const isChildrenMapCall: {
    (context: _eslint_react_types.RuleContext): (node: Node) => node is CallExpression & {
        callee: MemberExpression;
    };
    (node: Node, context: _eslint_react_types.RuleContext): node is CallExpression & {
...
declare const isChildrenOnlyCall: {
    (context: _eslint_react_types.RuleContext): (node: Node) => node is CallExpression & {
        callee: MemberExpression;
    };
    (node: Node, context: _eslint_react_types.RuleContext): node is CallExpression & {
...
declare const isChildrenToArrayCall: {
    (context: _eslint_react_types.RuleContext): (node: Node) => node is CallExpression & {
        callee: MemberExpression;
    };
    (node: Node, context: _eslint_react_types.RuleContext): node is CallExpression & {
...
declare const isCloneElementCall: {
    (context: _eslint_react_types.RuleContext): (node: Node) => node is CallExpression;
    (node: Node, context: _eslint_react_types.RuleContext): node is CallExpression;
};
declare const isCreateContextCall: {
    (context: _eslint_react_types.RuleContext): (node: Node) => node is CallExpression;
    (node: Node, context: _eslint_react_types.RuleContext): node is CallExpression;
};
declare const isCreateElementCall: {
    (context: _eslint_react_types.RuleContext): (node: Node) => node is CallExpression;
    (node: Node, context: _eslint_react_types.RuleContext): node is CallExpression;
};
declare const isCreateRefCall: {
    (context: _eslint_react_types.RuleContext): (node: Node) => node is CallExpression;
    (node: Node, context: _eslint_react_types.RuleContext): node is CallExpression;
};
declare const isForwardRefCall: {
    (context: _eslint_react_types.RuleContext): (node: Node) => node is CallExpression;
    (node: Node, context: _eslint_react_types.RuleContext): node is CallExpression;
};
declare const isMemoCall: {
    (context: _eslint_react_types.RuleContext): (node: Node) => node is CallExpression;
    (node: Node, context: _eslint_react_types.RuleContext): node is CallExpression;
};
