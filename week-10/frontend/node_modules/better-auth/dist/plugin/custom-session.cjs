"use strict";var Ae=Object.defineProperty;var Nt=Object.getOwnPropertyDescriptor;var $t=Object.getOwnPropertyNames;var Bt=Object.prototype.hasOwnProperty;var Vt=(e,t)=>{for(var r in t)Ae(e,r,{get:t[r],enumerable:!0})},Mt=(e,t,r,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of $t(t))!Bt.call(e,n)&&n!==r&&Ae(e,n,{get:()=>t[n],enumerable:!(o=Nt(t,n))||o.enumerable});return e};var qt=e=>Mt(Ae({},"__esModule",{value:!0}),e);var io={};Vt(io,{customSession:()=>no});module.exports=qt(io);var se=require("zod");var ie=require("better-call");var _e=require("better-call");var Z=require("better-call"),je=(0,Z.createMiddleware)(async()=>({})),X=(0,Z.createMiddlewareCreator)({use:[je,(0,Z.createMiddleware)(async()=>({}))]}),g=(0,Z.createEndpointCreator)({use:[je]});function Re(e){return e==="-"||e==="^"||e==="$"||e==="+"||e==="."||e==="("||e===")"||e==="|"||e==="["||e==="]"||e==="{"||e==="}"||e==="*"||e==="?"||e==="\\"?`\\${e}`:e}function zt(e){let t="";for(let r=0;r<e.length;r++)t+=Re(e[r]);return t}function Ne(e,t=!0){if(Array.isArray(e))return`(?:${e.map(l=>`^${Ne(l,t)}$`).join("|")})`;let r="",o="",n=".";t===!0?(r="/",o="[/\\\\]",n="[^/\\\\]"):t&&(r=t,o=zt(r),o.length>1?(o=`(?:${o})`,n=`((?!${o}).)`):n=`[^${o}]`);let i=t?`${o}+?`:"",s=t?`${o}*?`:"",c=t?e.split(r):[e],a="";for(let d=0;d<c.length;d++){let l=c[d],m=c[d+1],p="";if(!(!l&&d>0)){if(t&&(d===c.length-1?p=s:m!=="**"?p=i:p=""),t&&l==="**"){p&&(a+=d===0?"":p,a+=`(?:${n}*?${p})*?`);continue}for(let b=0;b<l.length;b++){let y=l[b];y==="\\"?b<l.length-1&&(a+=Re(l[b+1]),b++):y==="?"?a+=n:y==="*"?a+=`${n}*?`:a+=Re(y)}a+=p}}return a}function Ft(e,t){if(typeof t!="string")throw new TypeError(`Sample must be a string, but ${typeof t} given`);return e.test(t)}function pe(e,t){if(typeof e!="string"&&!Array.isArray(e))throw new TypeError(`The first argument must be a single pattern string or an array of patterns, but ${typeof e} given`);if((typeof t=="string"||typeof t=="boolean")&&(t={separator:t}),arguments.length===2&&!(typeof t>"u"||typeof t=="object"&&t!==null&&!Array.isArray(t)))throw new TypeError(`The second argument must be an options object or a string/boolean separator, but ${typeof t} given`);if(t=t||{},t.separator==="\\")throw new Error("\\ is not a valid separator because it is used for escaping. Try setting the separator to `true` instead");let r=Ne(e,t.separator),o=new RegExp(`^${r}$`,t.flags),n=Ft.bind(null,o);return n.options=t,n.pattern=e,n.regexp=o,n}var me=Object.create(null),de=e=>globalThis.process?.env||globalThis.Deno?.env.toObject()||globalThis.__env__||(e?me:globalThis),$e=new Proxy(me,{get(e,t){return de()[t]??me[t]},has(e,t){let r=de();return t in r||t in me},set(e,t,r){let o=de(!0);return o[t]=r,!0},deleteProperty(e,t){if(!t)return!1;let r=de(!0);return delete r[t],!0},ownKeys(){let e=de(!0);return Object.keys(e)}});function Ht(e){return e?e!=="false":!1}var ke=typeof process<"u"&&process.env&&process.env.NODE_ENV||"";var Ee=ke==="dev"||ke==="development",Gt=ke==="test"||Ht($e.TEST);var H=class extends Error{constructor(t,r){super(t),this.name="BetterAuthError",this.message=t,this.cause=r,this.stack=""}};function fe(e){try{return new URL(e).origin}catch{return null}}function Be(e){try{return new URL(e).protocol}catch{return null}}function Ue(e){return e.includes("://")?new URL(e).host:e}var Wt=X(async e=>{if(e.request?.method!=="POST")return;let{body:t,query:r,context:o}=e,n=e.headers?.get("origin")||e.headers?.get("referer")||"",i=t?.callbackURL||r?.callbackURL,s=t?.redirectTo,c=r?.currentURL,a=t?.errorCallbackURL,d=t?.newUserCallbackURL,l=o.trustedOrigins,m=e.headers?.has("cookie"),p=(y,T)=>{if(y.startsWith("/"))return!1;if(T.includes("*"))return pe(T)(Ue(y));let F=Be(y);return F==="http:"||F==="https:"||!F?T===fe(y):y.startsWith(T)},b=(y,T)=>{if(!y)return;if(!l.some(ae=>p(y,ae)||y?.startsWith("/")&&T!=="origin"&&!y.includes(":")))throw e.context.logger.error(`Invalid ${T}: ${y}`),e.context.logger.info(`If it's a valid URL, please add ${y} to trustedOrigins in your auth config
...
</html>`,Kr=g("/error",{method:"GET",metadata:{...te,openapi:{description:"Displays an error page",responses:{200:{description:"Success",content:{"text/html":{schema:{type:"string"}}}}}}}},async e=>{let t=new URL(e.request?.url||"").searchParams.get("error")||"Unknown";return new Response(Zr(t),{headers:{"Content-Type":"text/html"}})});var Yr=g("/ok",{method:"GET",metadata:{...te,openapi:{description:"Check if the API is working",responses:{200:{description:"Success",content:{"application/json":{schema:{type:"object",properties:{ok:{type:"boolean"}}}}}}}}}},async e=>e.json({ok:!0}));var Xr=require("zod");var eo=require("better-call");var J=require("zod");var ue=require("better-call");var to=g("/list-accounts",{method:"GET",use:[C],metadata:{openapi:{description:"List all accounts linked to the user",responses:{200:{description:"Success",content:{"application/json":{schema:{type:"array",items:{type:"object",properties:{id:{type:"string"},provider:{type:"string"}}}}}}}}}}},async e=>{let t=e.context.session,r=await e.context.internalAdapter.findAccounts(t.user.id);return e.json(r.map(o=>({id:o.id,provider:o.providerId,createdAt:o.createdAt,updatedAt:o.updatedAt,accountId:o.accountId,scopes:o.scope?.split(",")||[]})))}),ro=g("/link-social",{method:"POST",requireHeaders:!0,query:J.z.object({currentURL:J.z.string().optional()}).optional(),body:J.z.object({callbackURL:J.z.string({description:"The URL to redirect to after the user has signed in"}).optional(),provider:J.z.enum(Le,{description:"The OAuth2 provider to use"})}),use:[C],metadata:{openapi:{description:"Link a social account to the user",responses:{200:{description:"Success",content:{"application/json":{schema:{type:"object",properties:{url:{type:"string"},redirect:{type:"boolean"}},required:["url","redirect"]}}}}}}}},async e=>{let t=e.context.session;if((await e.context.internalAdapter.findAccounts(t.user.id)).find(c=>c.providerId===e.body.provider))throw new ue.APIError("BAD_REQUEST",{message:u.SOCIAL_ACCOUNT_ALREADY_LINKED});let n=e.context.socialProviders.find(c=>c.id===e.body.provider);if(!n)throw e.context.logger.error("Provider not found. Make sure to add the provider in your auth config",{provider:e.body.provider}),new ue.APIError("NOT_FOUND",{message:u.PROVIDER_NOT_FOUND});let i=await he(e,{userId:t.user.id,email:t.user.email}),s=await n.createAuthorizationURL({state:i.state,codeVerifier:i.codeVerifier,redirectURI:`${e.context.baseURL}/callback/${n.id}`});return e.json({url:s.toString(),redirect:!0})}),oo=g("/unlink-account",{method:"POST",body:J.z.object({providerId:J.z.string()}),use:[St]},async e=>{let t=await e.context.internalAdapter.findAccounts(e.context.session.user.id);if(t.length===1)throw new ue.APIError("BAD_REQUEST",{message:u.FAILED_TO_UNLINK_LAST_ACCOUNT});if(!t.find(o=>o.providerId===e.body.providerId))throw new ue.APIError("BAD_REQUEST",{message:u.ACCOUNT_NOT_FOUND});return await e.context.internalAdapter.deleteAccount(e.body.providerId,e.context.session.user.id),e.json({status:!0})});var Ie=require("better-call");var no=(e,t)=>({id:"custom-session",endpoints:{getSession:g("/get-session",{method:"GET",metadata:{CUSTOM_SESSION:!0},query:se.z.optional(se.z.object({disableCookieCache:se.z.boolean({description:"Disable cookie cache and fetch session from database"}).or(se.z.string().transform(r=>r==="true")).optional(),disableRefresh:se.z.boolean({description:"Disable session refresh. Useful for checking session status, without updating the session"}).optional()}))},async r=>{let o=await q(r);if(!o)return r.json(null);let n=await e(o);return r.json(n)})}});0&&(module.exports={customSession});
