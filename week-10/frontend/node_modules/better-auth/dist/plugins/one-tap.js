import{z as pt}from"zod";import{APIError as Sc,createRouter as xc,getCookie as Ic,getSignedCookie as Lc,setCookie as Pc,setSignedCookie as Dc}from"better-call";import{APIError as Pe}from"better-call";import{createEndpointCreator as ht,createMiddleware as ve,createMiddlewareCreator as wt}from"better-call";var Se=ve(async()=>({})),K=wt({use:[Se,ve(async()=>({}))]}),g=ht({use:[Se]});function we(e){return e==="-"||e==="^"||e==="$"||e==="+"||e==="."||e==="("||e===")"||e==="|"||e==="["||e==="]"||e==="{"||e==="}"||e==="*"||e==="?"||e==="\\"?`\\${e}`:e}function yt(e){let t="";for(let r=0;r<e.length;r++)t+=we(e[r]);return t}function xe(e,t=!0){if(Array.isArray(e))return`(?:${e.map(l=>`^${xe(l,t)}$`).join("|")})`;let r="",o="",n=".";t===!0?(r="/",o="[/\\\\]",n="[^/\\\\]"):t&&(r=t,o=yt(r),o.length>1?(o=`(?:${o})`,n=`((?!${o}).)`):n=`[^${o}]`);let i=t?`${o}+?`:"",s=t?`${o}*?`:"",c=t?e.split(r):[e],a="";for(let d=0;d<c.length;d++){let l=c[d],m=c[d+1],p="";if(!(!l&&d>0)){if(t&&(d===c.length-1?p=s:m!=="**"?p=i:p=""),t&&l==="**"){p&&(a+=d===0?"":p,a+=`(?:${n}*?${p})*?`);continue}for(let b=0;b<l.length;b++){let y=l[b];y==="\\"?b<l.length-1&&(a+=we(l[b+1]),b++):y==="?"?a+=n:y==="*"?a+=`${n}*?`:a+=we(y)}a+=p}}return a}function bt(e,t){if(typeof t!="string")throw new TypeError(`Sample must be a string, but ${typeof t} given`);return e.test(t)}function ce(e,t){if(typeof e!="string"&&!Array.isArray(e))throw new TypeError(`The first argument must be a single pattern string or an array of patterns, but ${typeof e} given`);if((typeof t=="string"||typeof t=="boolean")&&(t={separator:t}),arguments.length===2&&!(typeof t>"u"||typeof t=="object"&&t!==null&&!Array.isArray(t)))throw new TypeError(`The second argument must be an options object or a string/boolean separator, but ${typeof t} given`);if(t=t||{},t.separator==="\\")throw new Error("\\ is not a valid separator because it is used for escaping. Try setting the separator to `true` instead");let r=xe(e,t.separator),o=new RegExp(`^${r}$`,t.flags),n=bt.bind(null,o);return n.options=t,n.pattern=e,n.regexp=o,n}var de=Object.create(null),re=e=>globalThis.process?.env||globalThis.Deno?.env.toObject()||globalThis.__env__||(e?de:globalThis),Ie=new Proxy(de,{get(e,t){return re()[t]??de[t]},has(e,t){let r=re();return t in r||t in de},set(e,t,r){let o=re(!0);return o[t]=r,!0},deleteProperty(e,t){if(!t)return!1;let r=re(!0);return delete r[t],!0},ownKeys(){let e=re(!0);return Object.keys(e)}});function At(e){return e?e!=="false":!1}var ye=typeof process<"u"&&process.env&&process.env.NODE_ENV||"";var be=ye==="dev"||ye==="development",Rt=ye==="test"||At(Ie.TEST);var F=class extends Error{constructor(t,r){super(t),this.name="BetterAuthError",this.message=t,this.cause=r,this.stack=""}};function le(e){try{return new URL(e).origin}catch{return null}}function Le(e){try{return new URL(e).protocol}catch{return null}}function Ae(e){return e.includes("://")?new URL(e).host:e}var kt=K(async e=>{if(e.request?.method!=="POST")return;let{body:t,query:r,context:o}=e,n=e.headers?.get("origin")||e.headers?.get("referer")||"",i=t?.callbackURL||r?.callbackURL,s=t?.redirectTo,c=r?.currentURL,a=t?.errorCallbackURL,d=t?.newUserCallbackURL,l=o.trustedOrigins,m=e.headers?.has("cookie"),p=(y,T)=>{if(y.startsWith("/"))return!1;if(T.includes("*"))return ce(T)(Ae(y));let z=Le(y);return z==="http:"||z==="https:"||!z?T===le(y):y.startsWith(T)},b=(y,T)=>{if(!y)return;if(!l.some(ee=>p(y,ee)||y?.startsWith("/")&&T!=="origin"&&!y.includes(":")))throw e.context.logger.error(`Invalid ${T}: ${y}`),e.context.logger.info(`If it's a valid URL, please add ${y} to trustedOrigins in your auth config
